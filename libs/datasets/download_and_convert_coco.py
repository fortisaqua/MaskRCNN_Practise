      ...
      for shard_id in range(num_shards):
        ...
        with tf.python_io.TFRecordWriter(record_filename, options=options) as tfrecord_writer:
          ...
          for i in range(start_ndx, end_ndx):
            ...
            gt_boxes, masks, mask,non_annotation = _get_coco_masks(coco, img_id, height, width, img_name)
            ...
            if not non_annotation:
                ...
                checked_count+=1
        print('''\n\n===========================================================
                 shard %d has %d valid images
                 ===========================================================\n'''%(shard_id,checked_count))
  sys.stdout.write('\n')
  sys.stdout.flush()
